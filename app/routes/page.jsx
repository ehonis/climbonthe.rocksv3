    ...
    <main className="h-screen w-full">
      ...
      <div className="m-5 flex items-center justify-between">
        ...
        <div className="flex flex-row">
          <button className="ml-3 flex h-14 w-14 items-center justify-center rounded-full bg-bg1 first:ml-0">
            <svg
              className="h-10 w-10"
              viewBox="0 0 24 24"
              fill="none"
          ...
          <button className="group ml-3 flex h-14 w-14 items-center justify-center rounded-full bg-bg1 transition-all duration-300 ease-in-out first:ml-0 focus:bg-white">
            <svg
              className="h-10 w-10"
              version="1.1"
              id="_x32_"
            ...
            >
              ...
              <g>
                <path
                  strokeWidth="1.75"
                  className="fill-iconbg transition-all duration-300 ease-in-out group-focus:fill-red"
      ...
      <div className="m-5 flex items-center justify-between">
        ...
        <div className="flex flex-row">
          <button className="group ml-3 flex h-14 w-14 items-center justify-center rounded-full bg-bg1 shadow-2xl first:ml-0">
            <svg
              className="h-10 w-10"
              viewBox="0 0 24 24"
              fill="none"
